...
# Test with a PR opened event matching GitHub's structure
PAYLOAD='{
  "action": "opened",
  "pull_request": {
    "id": 1,
    "number": 123,
    "title": "[RSOLV] Fix null pointer exception in auth handler",
...
echo "Testing webhook with PR opened event..."
