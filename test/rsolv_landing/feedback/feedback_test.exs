defmodule RsolvLanding.FeedbackTest do
  use Rsolv.DataCase
  alias RsolvLanding.Feedback
  alias RsolvLanding.Feedback.Entry
  ...
  describe "feedback entries" do
    ...
    test "list_recent_entries/1 returns entries ordered by date" do
      ...
      {:ok, _old_entry} = %RsolvLanding.Feedback.Entry{}
        |> RsolvLanding.Feedback.Entry.changeset(@valid_attrs)
      ...
      {:ok, _new_entry} = %RsolvLanding.Feedback.Entry{}
        |> RsolvLanding.Feedback.Entry.changeset(%{@valid_attrs | email: "new@example.com"})
