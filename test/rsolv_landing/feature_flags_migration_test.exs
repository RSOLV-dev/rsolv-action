defmodule RsolvLanding.FeatureFlagsMigrationTest do
  use Rsolv.DataCase, async: false
  
  # Skip all tests in this module - FunWithFlags not properly set up in test env
  @moduletag :skip
  
  alias RsolvLanding.FeatureFlagsMigration
  alias RsolvLanding.FeatureFlags
  alias RsolvLanding.FeatureFlags.Groups
  alias FunWithFlags
  
  import RsolvLandingWeb.FunWithFlagsHelper
