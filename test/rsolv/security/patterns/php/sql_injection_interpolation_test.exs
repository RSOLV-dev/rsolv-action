defmodule Rsolv.Security.Patterns.Php.SqlInjectionInterpolationTest do
  ...
  describe "ast_enhancement/0" do
    test "returns proper enhancement rules" do
      ...
      interpolation_rule =
        Enum.find(enhancement.ast_rules, &(&1.type == "interpolation_detection"))
      ...
      # Wrong type of escaping
      assert "htmlspecialchars" not in sanitization_rule.escape_functions
    end
  end
