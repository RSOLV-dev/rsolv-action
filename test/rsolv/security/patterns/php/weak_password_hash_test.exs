defmodule Rsolv.Security.Patterns.Php.WeakPasswordHashTest do
  ...
  describe "regex matching" do
    ...
    test "does not match secure password hashing", %{pattern: pattern} do
      safe_code = [
        ...
        # Not password
        ~S|hash('sha256', $non_password_data);|,
        # File hashing, not password
        ~S|md5_file('document.pdf');|
      ]
  ...
  describe "ast_enhancement/0" do
    test "returns proper enhancement rules" do
      ...
      password_indicators_rule =
        Enum.find(enhancement.ast_rules, &(&1.type == "password_indicators"))
