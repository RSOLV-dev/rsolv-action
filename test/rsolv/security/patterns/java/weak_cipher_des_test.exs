defmodule Rsolv.Security.Patterns.Java.WeakCipherDesTest do
  ...
  describe "vulnerability_metadata/0" do
    ...
    test "includes DES-specific information" do
      ...
      assert String.contains?(metadata.description, "DES") or
               String.contains?(metadata.description, "Data Encryption Standard")
