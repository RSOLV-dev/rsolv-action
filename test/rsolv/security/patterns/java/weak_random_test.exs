defmodule Rsolv.Security.Patterns.Java.WeakRandomTest do
  ...
  describe "vulnerability_metadata/0" do
    ...
    test "includes random-specific information" do
      ...
      assert String.contains?(metadata.description, "random") or
               String.contains?(metadata.description, "PRNG")
