defmodule Rsolv.Security.Patterns.Java.LdapInjectionTest do
  ...
  describe "vulnerability_metadata/0" do
    ...
    test "includes LDAP-specific information" do
      ...
      assert String.contains?(metadata.description, "LDAP") or
               String.contains?(metadata.description, "directory")
