defmodule Rsolv.Security.Patterns.Java.HardcodedPasswordTest do
  ...
  describe "vulnerability_metadata/0" do
    ...
    test "includes credential-specific information" do
      ...
      assert String.contains?(metadata.description, "hardcoded") or
               String.contains?(metadata.description, "password")
