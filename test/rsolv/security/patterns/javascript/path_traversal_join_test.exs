defmodule Rsolv.Security.Patterns.Javascript.PathTraversalJoinTest do
  use ExUnit.Case, async: true

  alias Rsolv.Security.Patterns.Javascript.PathTraversalJoin
  ...
  describe "PathTraversalJoin pattern" do
    test "pattern/0 returns correct structure" do
      ...
      assert pattern.description ==
               "Using path.join with user input can lead to directory traversal"
