defmodule Rsolv.Security.Patterns.Javascript.XssDocumentWriteTest do
  use ExUnit.Case, async: true

  alias Rsolv.Security.Patterns.Javascript.XssDocumentWrite
  ...
  describe "vulnerability_metadata/0" do
    test "returns comprehensive vulnerability information" do
      ...
      assert Enum.any?(
               ref_urls,
               &(String.contains?(&1, "document.write") || String.contains?(&1, "document-write"))
             )
    end
