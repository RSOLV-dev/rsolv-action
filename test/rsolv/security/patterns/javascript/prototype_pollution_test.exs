defmodule Rsolv.Security.Patterns.Javascript.PrototypePollutionTest do
  use ExUnit.Case, async: true

  alias Rsolv.Security.Patterns.Javascript.PrototypePollution
  ...
  describe "PrototypePollution pattern" do
    test "returns correct pattern structure with all required fields" do
      ...
      assert pattern.description ==
               "Unsafe object property assignment can pollute object prototypes"
    ...
    test "correctly identifies applicable file types for JavaScript and TypeScript" do
      ...
      for file <- javascript_files do
        assert PrototypePollution.applies_to_file?(file, nil),
      ...
      for file <- other_language_files do
        refute PrototypePollution.applies_to_file?(file, nil),
