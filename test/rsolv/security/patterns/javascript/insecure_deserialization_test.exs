defmodule Rsolv.Security.Patterns.Javascript.InsecureDeserializationTest do
  use ExUnit.Case, async: true

  alias Rsolv.Security.Patterns.Javascript.InsecureDeserialization
  ...
  describe "InsecureDeserialization pattern" do
    ...
    test "correctly identifies applicable file types for JavaScript and TypeScript" do
      ...
      for file <- javascript_files do
        assert InsecureDeserialization.applies_to_file?(file, nil),
      ...
      for file <- other_language_files do
        refute InsecureDeserialization.applies_to_file?(file, nil),
