defmodule Rsolv.Security.Patterns.Javascript.XxeExternalEntitiesTest do
  use ExUnit.Case, async: true

  alias Rsolv.Security.Patterns.Javascript.XxeExternalEntities
  ...
  describe "XxeExternalEntities pattern structure" do
    test "returns correct pattern structure with all required fields" do
      ...
      assert pattern.description ==
               "XML parsers with external entities enabled can read files and perform SSRF"
