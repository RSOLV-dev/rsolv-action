defmodule Rsolv.Security.Patterns.Javascript.OpenRedirectTest do
  use ExUnit.Case, async: true

  alias Rsolv.Security.Patterns.Javascript.OpenRedirect
  ...
  describe "OpenRedirect pattern structure" do
    test "returns correct pattern structure with all required fields" do
      ...
      assert pattern.description ==
               "Redirecting to user-controlled URLs can lead to phishing attacks"
