defmodule Rsolv.Security.Patterns.Javascript.EvalUserInputTest do
  ...
  describe "ast_enhancement/0" do
    ...
    test "AST rules target eval call expressions" do
      ...
      assert enhancement.ast_rules.callee.alternatives == [
               "Function",
               "setTimeout",
               "setInterval"
             ]
    ...
    test "context rules exclude test files and safe patterns" do
      ...
      assert enhancement.context_rules.high_risk_sources == [
               "req.body",
               "req.query",
               "localStorage",
               "location.search"
    ...
    test "confidence rules heavily penalize safe patterns" do
      ...
      # Lowered to catch eval(input) - critical vulnerability
