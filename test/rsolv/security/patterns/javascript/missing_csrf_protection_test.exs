defmodule Rsolv.Security.Patterns.Javascript.MissingCsrfProtectionTest do
  use ExUnit.Case, async: true
  doctest Rsolv.Security.Patterns.Javascript.MissingCsrfProtection

  alias Rsolv.Security.Pattern
  alias Rsolv.Security.Patterns.Javascript.MissingCsrfProtection
  ...
  describe "ast_enhancement/0" do
    ...
    test "AST rules target Express route methods" do
      ...
      assert enhancement.ast_rules.callee.object_patterns == [
               "app",
               "router",
               "apiRouter",
               "adminRouter"
