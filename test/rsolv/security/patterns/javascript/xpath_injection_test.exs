defmodule Rsolv.Security.Patterns.Javascript.XpathInjectionTest do
  use ExUnit.Case, async: true
  alias Rsolv.Security.Pattern
  alias Rsolv.Security.Patterns.Javascript.XpathInjection
  ...
  describe "detection tests" do
    ...
    test "detects complex XPath expressions" do
      ...
      vulnerable_code =
        ~S|xpath.select("//user[name='" + name + "' and password='" + pass + "']")|
  ...
  describe "ast_enhancement/0" do
    ...
    test "context rules exclude test files and parameterized queries" do
      ...
      assert enhancement.context_rules.safe_xpath_patterns == [
               "xpath.compile",
               "createExpression"
             ]
    end
