defmodule Rsolv.Security.Patterns.Javascript.CommandInjectionExecTest do
  use ExUnit.Case, async: true
  doctest Rsolv.Security.Patterns.Javascript.CommandInjectionExec
  
  alias Rsolv.Security.Patterns.Javascript.CommandInjectionExec
