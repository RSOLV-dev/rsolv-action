defmodule Rsolv.Security.Patterns.Django.AuthorizationBypassTest do
  use ExUnit.Case
  ...
  describe "pattern/0" do
    test "returns correct pattern structure" do
      ...
      assert pattern.description ==
               "Missing or insufficient permission checks allowing unauthorized access"
    ...
    test "includes test cases for vulnerable code" do
      ...
      assert Enum.any?(
               pattern.test_cases.vulnerable,
               &(&1 =~ "get_object_or_404(Document, pk=doc_id)")
             )
