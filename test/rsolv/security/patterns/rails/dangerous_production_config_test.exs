defmodule Rsolv.Security.Patterns.Rails.DangerousProductionConfigTest do
  ...
  describe "dangerous_production_config pattern" do
    ...
    test "vulnerability metadata contains production configuration specific information" do
      ...
      assert String.contains?(
               String.downcase(metadata.remediation_steps),
    ...
    test "applies to ruby files with Rails framework" do
      ...
      refute DangerousProductionConfig.applies_to_file?("config/environments/production.rb", [
               "sinatra"
             ])
