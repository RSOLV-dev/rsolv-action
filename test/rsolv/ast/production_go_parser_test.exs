defmodule Rsolv.AST.ProductionGoParserTest do
  ...
  describe "Production Go Parser" do
    ...
    test "parses simple Go code with production parser", %{
    ...
    test "detects dangerous function patterns in Go code", %{
      customer_id: customer_id,
      session_id: session_id
    } do
      code = """
    ...
    test "handles Go syntax errors gracefully", %{
      customer_id: customer_id,
      session_id: session_id
    } do
      code = """
    ...
    test "detects goroutine and channel patterns", %{
      customer_id: customer_id,
      session_id: session_id
    } do
      code = """
    ...
    test "detects interface and struct patterns", %{
      customer_id: customer_id,
      session_id: session_id
    } do
      code = """
