defmodule Rsolv.AST.ProductionPhpParserTest do
  ...
  describe "Production PHP Parser" do
    ...
    test "parses simple PHP code with production parser", %{
    ...
    test "detects dangerous function patterns in PHP code", %{
      customer_id: customer_id,
      session_id: session_id
    } do
      code = """
    ...
    test "handles PHP syntax errors gracefully", %{
      customer_id: customer_id,
      session_id: session_id
    } do
      code = """
    ...
    test "detects string concatenation patterns", %{
      customer_id: customer_id,
      session_id: session_id
    } do
      code = """
    ...
    test "detects variable variables patterns", %{
      customer_id: customer_id,
      session_id: session_id
    } do
      code = """
