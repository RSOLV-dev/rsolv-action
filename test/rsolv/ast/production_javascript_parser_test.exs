defmodule Rsolv.AST.ProductionJavaScriptParserTest do
  ...
  describe "Production JavaScript Parser" do
    ...
    test "parses simple JavaScript code with production parser", %{customer_id: customer_id, session_id: session_id} do
      code = """
    ...
    test "detects XSS patterns in JavaScript code", %{customer_id: customer_id, session_id: session_id} do
      code = """
    ...
    test "handles JavaScript syntax errors gracefully", %{customer_id: customer_id, session_id: session_id} do
      code = """
    ...
    test "parses complex JavaScript constructs", %{customer_id: customer_id, session_id: session_id} do
      ...
      body = program["body"]
      assert is_list(body)
      assert length(body) >= 3  # import, import, class, export
      
      # Should contain class declaration
      class_decl = Enum.find(body, fn node ->
  ...
  describe "Production TypeScript Parser" do
    ...
    test "parses TypeScript code with type annotations", %{customer_id: customer_id, session_id: session_id} do
      code = """
      interface User {
          id: number;
          name: string;
      ...
      interface_decl = Enum.find(body, fn node ->
    ...
    test "detects security patterns in TypeScript", %{customer_id: customer_id, session_id: session_id} do
      code = """
