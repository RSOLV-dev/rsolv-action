defmodule Rsolv.AST.ProductionPythonParserTest do
  ...
  describe "Production Python Parser" do
    ...
    test "parses simple Python code with production parser", %{
    ...
    test "detects SQL injection patterns in Python code", %{
      customer_id: customer_id,
      session_id: session_id
    } do
      code = """
