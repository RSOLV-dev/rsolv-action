defmodule RsolvLandingWeb.Services.ConvertKitTest do
  use Rsolv.DataCase, async: true
  import Mox
  alias RsolvLandingWeb.Services.ConvertKit
  ...
  describe "subscribe_to_early_access/2" do
    ...
    test "works in development mode without API key" do
      ...
      Application.put_env(:rsolv_landing, :convertkit, config_without_key)
  ...
  describe "unsubscribe/1" do
    ...
    test "creates fallback record when unsubscribe fails", %{fixtures: fixtures, test_email: email} do
      ...
      assert RsolvLanding.EmailManagement.get_unsubscribe_by_email(email) != nil
    end
