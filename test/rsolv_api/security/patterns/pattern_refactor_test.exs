defmodule RsolvApi.Security.Patterns.PatternRefactorTest do
  use ExUnit.Case
  ...
  describe "refactored pattern structure" do
    ...
    test "cross-language patterns can be loaded from common directory" do
      ...
      pattern = RsolvApi.Security.Patterns.Common.WeakJwtSecret.pattern()
    ...
    test "pattern module includes doctests showing vulnerable and safe code" do
      ...
      module_docs = Code.fetch_docs(RsolvApi.Security.Patterns.Javascript.SqlInjectionConcat)
    ...
    test "pattern includes structured vulnerability metadata" do
      ...
      pattern = RsolvApi.Security.Patterns.Javascript.SqlInjectionConcat.pattern()
      metadata = RsolvApi.Security.Patterns.Javascript.SqlInjectionConcat.vulnerability_metadata()
    ...
    test "pattern registry can collect patterns from individual modules" do
      ...
      patterns = RsolvApi.Security.PatternRegistry.get_patterns_for_language("javascript")
