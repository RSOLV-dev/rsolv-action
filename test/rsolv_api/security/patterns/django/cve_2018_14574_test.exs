defmodule RsolvApi.Security.Patterns.Django.Cve201814574Test do
  ...
  describe "Django CVE-2018-14574 pattern" do
    test "returns correct pattern structure" do
      ...
      assert pattern.description == "Open redirect in CommonMiddleware via APPEND_SLASH and URL redirection"
