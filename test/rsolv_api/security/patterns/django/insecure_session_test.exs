defmodule RsolvApi.Security.Patterns.Django.InsecureSessionTest do
  use ExUnit.Case
  ...
  describe "pattern/0" do
    test "returns correct pattern structure" do
      ...
      assert pattern.description == "Session cookies without secure flags expose sessions to interception"
  ...
  describe "vulnerability_metadata/0" do
    ...
    test "includes relevant CVE examples" do
      ...
      assert "CVE-2014-0482" in cve_ids  # RemoteUserMiddleware session hijacking
      assert "CVE-2015-3982" in cve_ids  # Session flushing vulnerability
      assert "CVE-2020-5224" in cve_ids  # django-user-sessions key exposure
    end
