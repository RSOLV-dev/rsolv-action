defmodule RsolvApi.Security.Patterns.Django.Cve202133571Test do
  ...
  describe "Django CVE-2021-33571 pattern" do
    test "returns correct pattern structure" do
      ...
      assert pattern.description == "IPv4 addresses with leading zeros can bypass validation in URLValidator and validate_ipv4_address"
