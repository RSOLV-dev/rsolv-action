defmodule RsolvApi.Security.Patterns.Javascript.SsrfTest do
  use ExUnit.Case, async: true
  doctest RsolvApi.Security.Patterns.Javascript.Ssrf
  
  alias RsolvApi.Security.Pattern
  alias RsolvApi.Security.Patterns.Javascript.Ssrf
