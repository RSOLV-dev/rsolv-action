defmodule RsolvApi.Security.Patterns.Javascript.CommandInjectionSpawnTest do
  use ExUnit.Case, async: true
  doctest RsolvApi.Security.Patterns.Javascript.CommandInjectionSpawn
  
  alias RsolvApi.Security.Patterns.Javascript.CommandInjectionSpawn
  ...
  describe "CommandInjectionSpawn pattern" do
    ...
    test "correctly identifies applicable file types for JavaScript and TypeScript" do
      ...
      for file <- javascript_files do
        assert CommandInjectionSpawn.applies_to_file?(file),
      ...
      for file <- other_language_files do
        refute CommandInjectionSpawn.applies_to_file?(file),
