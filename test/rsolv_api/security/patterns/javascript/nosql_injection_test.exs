defmodule RsolvApi.Security.Patterns.Javascript.NosqlInjectionTest do
  use ExUnit.Case, async: true
  doctest RsolvApi.Security.Patterns.Javascript.NosqlInjection
  
  alias RsolvApi.Security.Pattern
  alias RsolvApi.Security.Patterns.Javascript.NosqlInjection
