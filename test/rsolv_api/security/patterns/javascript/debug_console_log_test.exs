defmodule RsolvApi.Security.Patterns.Javascript.DebugConsoleLogTest do
  use ExUnit.Case, async: true
  doctest RsolvApi.Security.Patterns.Javascript.DebugConsoleLog
  
  alias RsolvApi.Security.Pattern
  alias RsolvApi.Security.Patterns.Javascript.DebugConsoleLog
