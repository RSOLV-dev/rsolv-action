defmodule RsolvApi.Security.Patterns.Javascript.JwtNoneAlgorithmTest do
  use ExUnit.Case, async: true
  doctest RsolvApi.Security.Patterns.Javascript.JwtNoneAlgorithm
  
  alias RsolvApi.Security.Pattern
  alias RsolvApi.Security.Patterns.Javascript.JwtNoneAlgorithm
