defmodule RsolvApi.Security.Patterns.Javascript.TimingAttackComparisonTest do
  use ExUnit.Case, async: true
  doctest RsolvApi.Security.Patterns.Javascript.TimingAttackComparison
  
  alias RsolvApi.Security.Pattern
  alias RsolvApi.Security.Patterns.Javascript.TimingAttackComparison
