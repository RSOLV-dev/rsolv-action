defmodule RsolvApi.Security.Patterns.Ruby.DebugModeEnabledTest do
  ...
  describe "ast_enhancement/0" do
    ...
    test "includes debug-specific AST rules" do
      ...
      assert "pry" in enhancement.ast_rules.method_names || "pry" in enhancement.ast_rules.require_names
    end
