defmodule RsolvApi.AST.ConfidenceScorerTest do
  ...
  describe "calculate_confidence/3" do
    ...
    test "low confidence when framework protection is detected" do
      match_context = %{
        ...
        has_user_input: true,
        in_database_call: true,
        framework_protection: true  # Using ORM or parameterized queries
      }
    ...
    test "adjusts confidence based on code complexity" do
      ...
      complex_confidence = ConfidenceScorer.calculate_confidence(complex_context, "javascript", %{})
    ...
    test "reduces confidence in test files" do
      ...
      assert test_confidence < 0.3  # Very low confidence in test files
    end
    ...
    test "considers pattern severity in confidence calculation" do
      ...
      high_confidence = ConfidenceScorer.calculate_confidence(high_severity_context, "python", %{})
    ...
    test "handles partial AST matches with reduced confidence" do
      ...
      assert partial_confidence >= 0.4  # Still reportable but lower
    end
