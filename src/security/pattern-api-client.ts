...
export class PatternAPIClient {
  ...
  private mapVulnerabilityType(type: string): VulnerabilityType {
    const typeMap: Record<string, VulnerabilityType> = {
      ...
      'cryptographic_failure': VulnerabilityType.WEAK_CRYPTOGRAPHY,
      ...
      'insecure_jwt': VulnerabilityType.BROKEN_AUTHENTICATION,
      ...
      'debug_mode': VulnerabilityType.DEBUG_MODE,
      ...
      'file_inclusion': VulnerabilityType.PATH_TRAVERSAL,
      ...
      'clickjacking': VulnerabilityType.SECURITY_MISCONFIGURATION,
      'sensitive_data_exposure': VulnerabilityType.SENSITIVE_DATA_EXPOSURE,
      'mass_assignment': VulnerabilityType.MASS_ASSIGNMENT,
      'logging': VulnerabilityType.INSUFFICIENT_LOGGING,
      'log_injection': VulnerabilityType.LOG_INJECTION,
