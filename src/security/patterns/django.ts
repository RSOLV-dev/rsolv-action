...
/**
 * Django framework-specific security patterns
 * Covers Django-specific vulnerabilities beyond base Python patterns
 */
export const djangoSecurityPatterns: SecurityPattern[] = [
  ...
  // Django Template Security Vulnerabilities
  {
  ...
  },
  {
    ...
    patterns: {
      regex: [
        ...
        /SESSION_COOKIE_AGE\s*=\s*31536000/g,  // 1 year
  ...
  // Django Authentication & Authorization Issues
  {
  ...
  // Django CSRF and Security Middleware Issues
  {
  ...
  // Django URL Routing Vulnerabilities
  {
