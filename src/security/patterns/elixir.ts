...
export const elixirSecurityPatterns: SecurityPattern[] = [
  ...
  // Additional patterns for better OWASP coverage
  {
  ...
  // Additional patterns for complete OWASP coverage
  {
...
// Export as default for consistency with other pattern files
export default elixirSecurityPatterns;