 ...
 * Covers Rails-specific vulnerabilities beyond base Ruby patterns
 */
export const railsSecurityPatterns: SecurityPattern[] = [
...
def user_params
  ...
  // Rails ActiveRecord Injection Vulnerabilities
  {
  ...
  // Rails Template Vulnerabilities
  {
  ...
  // Rails Configuration Vulnerabilities
  {
  ...
  // Rails Session Management Vulnerabilities
  {
