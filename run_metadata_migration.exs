...
case Repo.query("ALTER TABLE analytics_events ADD COLUMN IF NOT EXISTS metadata JSONB DEFAULT '{}'") do
  {:ok, _} ->
...
Repo.query("INSERT INTO schema_migrations (version, inserted_at) VALUES ('20250918023434', NOW()) ON CONFLICT DO NOTHING")
