          ...
          <div class="flex items-center justify-between py-4 text-sm">
            <div class="flex items-center gap-4">
              <a href="/" class="flex items-center">
                <img
                  src="/images/rsolv_logo_transparent.png"
                  width="100"
            ...
            <nav class="hidden md:flex items-center gap-8">
              <a
                href="/#features"
                class="font-medium text-gray-700 dark:text-white/90 hover:text-gray-900 dark:hover:text-white transition-colors"
              >
                Features
              </a>
              <a
              ...
              <div class="bg-white dark:bg-dark-800 rounded-lg shadow-lg p-8">
                ...
                <%= if @submitted do %>
                  <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6 text-center">
                    <span class="hero-solid-check-circle w-12 h-12 text-green-500 mx-auto mb-3 block">
                    </span>
    ...
    <!-- Contact Info -->
              <div class="space-y-8">
                  ...
                  <ul class="space-y-3">
                    <li class="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="mailto:sales@rsolv.dev" class="text-brand-blue hover:underline">
                          sales@rsolv.dev
                        </a>
                      </div>
                    </li>
                    <li class="flex items-start">
                      <span class="hero-solid-chat-bubble-left-right w-5 h-5 text-brand-green mr-3 mt-1">
                      </span>
                      <div>
                ...
                <div class="bg-white dark:bg-dark-800 rounded-lg shadow-lg p-8">
                  ...
                  <ul class="space-y-2">
                    <li class="flex items-start">
                      <span class="hero-solid-check-circle w-5 h-5 text-brand-green mr-2 mt-0.5">
                      </span>
        ...
        case EmailService.send_contact_form_notification(contact_data) do
          ...
          {:error, error_details} ->
            ...
            {:noreply,
             assign(socket,
               error:
                 "Failed to send message. Please try again or email us directly at sales@rsolv.dev"
             )}
        end
