defmodule RsolvApi.Security.PatternEnhancer do
  @moduledoc """
  ...
  def enhance(%{type: "logging"} = pattern) do
    ...
    |> Map.put(:base_confidence, 0.6)  # Lower confidence for logging patterns
  ...
  """
  def enabled? do
    Application.get_env(:rsolv_api, :enhanced_patterns, false)
  end
end