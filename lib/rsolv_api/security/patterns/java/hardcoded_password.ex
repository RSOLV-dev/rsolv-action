defmodule RsolvApi.Security.Patterns.Java.HardcodedPassword do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> pattern = RsolvApi.Security.Patterns.Java.HardcodedPassword.pattern()
      iex> pattern.id
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Java.HardcodedPassword.ast_enhancement()
