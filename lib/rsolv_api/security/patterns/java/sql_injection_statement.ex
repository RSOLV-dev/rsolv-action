defmodule RsolvApi.Security.Patterns.Java.SqlInjectionStatement do
  @moduledoc """
...
pstmt.setString(1, productName);|
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Java.SqlInjectionStatement.ast_enhancement()
