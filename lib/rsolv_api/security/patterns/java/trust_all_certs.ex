defmodule RsolvApi.Security.Patterns.Java.TrustAllCerts do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> pattern = RsolvApi.Security.Patterns.Java.TrustAllCerts.pattern()
      iex> pattern.id
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Java.TrustAllCerts.ast_enhancement()
