defmodule RsolvApi.Security.Patterns.Django.Cve201814574 do
  @moduledoc """
    ...
    %{
      ...
      references: [
        ...
        %{
          ...
          url: "https://www.stackhawk.com/blog/django-open-redirect-guide-examples-and-prevention/"
        }
      ],
      attack_vectors: [
      ...
      cve_examples: [
        %{
          id: "CVE-2018-14574",
          description: "Django CommonMiddleware open redirect vulnerability allowing phishing attacks via malicious URL redirection",
          severity: "medium",
          cvss: 6.1,
    ...
    %{
      rules: [
        %{
          ...
          description: "Exclude if using patched Django versions, URL validation, or APPEND_SLASH disabled"
        },
        %{
          type: :validation,
          context: %{
