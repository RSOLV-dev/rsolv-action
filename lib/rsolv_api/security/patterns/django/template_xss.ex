defmodule RsolvApi.Security.Patterns.Django.TemplateXss do
  @moduledoc """
  ...
  def vulnerability_metadata do
    %{
      ...
      likelihood: "High - Developers often use |safe filter for convenience without considering security implications",
  ...
  def ast_enhancement do
    %{
      ...
      context_rules: %{
        ...
        unsafe_filters: [
          "safe", "safeseq", "mark_safe"
        ],
        
        # User input indicators
        user_variables: [
          "request", "user_input", "user_data", "comment",
          "message", "content", "description", "bio", "text"
        ],
        
        # Template control structures
        template_controls: [
          "autoescape", "filter", "load", "include"
        ],
        ...
        sanitizers: [
          "bleach", "html_sanitizer", "nh3", "sanitize_html"
        ]
      },
  ...
  def applies_to_file?(file_path, frameworks ) do
    ...
    is_django_file = String.contains?(file_path, "template") ||
