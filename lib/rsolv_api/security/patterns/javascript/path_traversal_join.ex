defmodule RsolvApi.Security.Patterns.Javascript.PathTraversalJoin do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Javascript.PathTraversalJoin.ast_enhancement()
