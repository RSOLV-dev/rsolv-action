defmodule RsolvApi.Security.Patterns.Javascript.DebugConsoleLog do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> pattern = RsolvApi.Security.Patterns.Javascript.DebugConsoleLog.pattern()
      iex> pattern.id
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Javascript.DebugConsoleLog.ast_enhancement()
