defmodule RsolvApi.Security.Patterns.Javascript.CommandInjectionExec do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> pattern = RsolvApi.Security.Patterns.Javascript.CommandInjectionExec.pattern()
      iex> pattern.id
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Javascript.CommandInjectionExec.ast_enhancement()
