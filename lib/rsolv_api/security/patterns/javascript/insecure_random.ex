defmodule RsolvApi.Security.Patterns.Javascript.InsecureRandom do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> pattern = RsolvApi.Security.Patterns.Javascript.InsecureRandom.pattern()
      iex> pattern.id
      "js-insecure-random"
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Javascript.InsecureRandom.ast_enhancement()
