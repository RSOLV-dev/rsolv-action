defmodule RsolvApi.Security.Patterns.Javascript.JwtNoneAlgorithm do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> pattern = RsolvApi.Security.Patterns.Javascript.JwtNoneAlgorithm.pattern()
      iex> pattern.id
  ...
  def vulnerability_metadata do
    %{
      ...
      cve_examples: [
        %{
          id: "CVE-2015-2951",
          description: "The node-jsonwebtoken library before 4.2.2 allows remote attackers to bypass authentication via an 'alg':'none' header",
          severity: "critical",
          cvss: 9.8,
        ...
        %{
          id: "CVE-2016-10555",
          description: "The jsjws library before 0.1.3 allows remote attackers to bypass authentication by specifying 'none' algorithm",
          severity: "critical",
          cvss: 9.8,
        ...
        %{
          id: "CVE-2018-0114",
          description: "node-jose before 0.11.0 allows attackers to bypass authentication using 'none' algorithm",
          severity: "critical",
          cvss: 9.8,
        ...
        %{
          id: "CVE-2022-23529",
          description: "node-jsonwebtoken before 9.0.0 has insecure default for JWT verification allowing 'none' algorithm",
          severity: "high",
          cvss: 7.5,
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Javascript.JwtNoneAlgorithm.ast_enhancement()
  ...
  def ast_enhancement do
    %{
      ast_rules: %{
        ...
        argument_analysis: %{
          has_three_arguments: false,  # Two args = definitely vulnerable
      ...
      context_rules: %{
        ...
        exclude_if_algorithms_enforced: true,  # Middleware enforces algorithms
        exclude_if_wrapped_securely: true,     # Custom wrapper with algorithms
        safe_jwt_libraries: ["jose", "jwks-rsa", "@panva/jose"]  # Libraries with better defaults
      },
      confidence_rules: %{
        base: 0.4,
        adjustments: %{
          "no_options_object" => 0.4,        # jwt.verify(token, secret) - very likely vulnerable
          "no_algorithms_option" => 0.3,     # Has options but no algorithms
          "has_algorithms_option" => -0.9,   # Explicitly sets algorithms - safe
          "in_test_code" => -0.5,            # Test code often simplified
          "using_safe_library" => -0.6,      # Using library with secure defaults
          "wrapped_in_function" => -0.3      # Might have central validation
        }
      },
      min_confidence: 0.7
    }
