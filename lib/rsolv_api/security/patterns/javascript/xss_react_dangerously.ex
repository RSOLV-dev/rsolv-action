defmodule RsolvApi.Security.Patterns.Javascript.XssReactDangerously do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> pattern = RsolvApi.Security.Patterns.Javascript.XssReactDangerously.pattern()
      iex> pattern.id
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Javascript.XssReactDangerously.ast_enhancement()
