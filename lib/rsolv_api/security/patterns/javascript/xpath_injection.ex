defmodule RsolvApi.Security.Patterns.Javascript.XpathInjection do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> pattern = RsolvApi.Security.Patterns.Javascript.XpathInjection.pattern()
      iex> pattern.id
      "js-xpath-injection"
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Javascript.XpathInjection.ast_enhancement()
