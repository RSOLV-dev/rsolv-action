defmodule RsolvApi.Security.Patterns.Elixir.SqlInjectionFragment do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Elixir.SqlInjectionFragment.ast_enhancement()
