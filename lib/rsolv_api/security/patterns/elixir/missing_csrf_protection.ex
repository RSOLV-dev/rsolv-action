defmodule RsolvApi.Security.Patterns.Elixir.MissingCsrfProtection do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Elixir.MissingCsrfProtection.ast_enhancement()
