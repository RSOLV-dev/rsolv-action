defmodule RsolvApi.Security.Patterns.Php.XssEcho do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> test_cases = RsolvApi.Security.Patterns.Php.XssEcho.test_cases()
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Php.XssEcho.ast_enhancement()
