defmodule RsolvApi.Security.Patterns.Php.CommandInjection do
  @moduledoc """
...
$files = scandir($directory);|
  ...
  ## Examples
      ...
      iex> test_cases = RsolvApi.Security.Patterns.Php.CommandInjection.test_cases()
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Php.CommandInjection.ast_enhancement()
