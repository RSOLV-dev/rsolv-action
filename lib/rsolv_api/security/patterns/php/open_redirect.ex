defmodule RsolvApi.Security.Patterns.Php.OpenRedirect do
  @moduledoc """
...
if (in_array($redirect, $allowed_urls)) {
  ...
  ## Examples
      ...
      iex> test_cases = RsolvApi.Security.Patterns.Php.OpenRedirect.test_cases()
  ...
  ## Examples
      ...
      iex> examples = RsolvApi.Security.Patterns.Php.OpenRedirect.examples()
  ...
  ## Examples
      ...
      iex> desc = RsolvApi.Security.Patterns.Php.OpenRedirect.vulnerability_description()
      iex> desc =~ "redirect"
      true
