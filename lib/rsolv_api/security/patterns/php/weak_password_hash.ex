defmodule RsolvApi.Security.Patterns.Php.WeakPasswordHash do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> test_cases = RsolvApi.Security.Patterns.Php.WeakPasswordHash.test_cases()
      ...
      iex> pattern = RsolvApi.Security.Patterns.Php.WeakPasswordHash.pattern()
      iex> pattern.id
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Php.WeakPasswordHash.ast_enhancement()
