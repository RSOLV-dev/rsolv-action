defmodule RsolvApi.Security.Patterns.Php.UnsafeDeserialization do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> test_cases = RsolvApi.Security.Patterns.Php.UnsafeDeserialization.test_cases()
      ...
      iex> pattern = RsolvApi.Security.Patterns.Php.UnsafeDeserialization.pattern()
      iex> pattern.id
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Php.UnsafeDeserialization.ast_enhancement()
