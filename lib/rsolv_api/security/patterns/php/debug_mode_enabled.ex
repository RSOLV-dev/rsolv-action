defmodule RsolvApi.Security.Patterns.Php.DebugModeEnabled do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> test_cases = RsolvApi.Security.Patterns.Php.DebugModeEnabled.test_cases()
  ...
  ## Examples
      ...
      iex> examples = RsolvApi.Security.Patterns.Php.DebugModeEnabled.examples()
  ...
  ## Examples
      ...
      iex> desc = RsolvApi.Security.Patterns.Php.DebugModeEnabled.vulnerability_description()
      iex> desc =~ "debug"
      true
