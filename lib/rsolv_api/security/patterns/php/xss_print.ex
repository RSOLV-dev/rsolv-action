defmodule RsolvApi.Security.Patterns.Php.XssPrint do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> test_cases = RsolvApi.Security.Patterns.Php.XssPrint.test_cases()
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Php.XssPrint.ast_enhancement()
      ...
      ast_rules: [
        %{
          ...
          functions: [
            ...
            "printf",
            "vprintf",
            "print_r"  # When second param is false
          ]
        },
        %{
        ...
        %{
          ...
          patterns: [
            ...
            "var_export",      # When second param is true
