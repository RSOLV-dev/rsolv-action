defmodule RsolvApi.Security.Patterns.Php.LdapInjection do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> test_cases = RsolvApi.Security.Patterns.Php.LdapInjection.test_cases()
  ...
  ## Examples
      ...
      iex> examples = RsolvApi.Security.Patterns.Php.LdapInjection.examples()
  ...
  ## Examples
      ...
      iex> desc = RsolvApi.Security.Patterns.Php.LdapInjection.vulnerability_description()
