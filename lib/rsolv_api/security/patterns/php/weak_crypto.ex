defmodule RsolvApi.Security.Patterns.Php.WeakCrypto do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> test_cases = RsolvApi.Security.Patterns.Php.WeakCrypto.test_cases()
  ...
  ## Examples
      ...
      iex> examples = RsolvApi.Security.Patterns.Php.WeakCrypto.examples()
  ...
  ## Examples
      ...
      iex> desc = RsolvApi.Security.Patterns.Php.WeakCrypto.vulnerability_description()
