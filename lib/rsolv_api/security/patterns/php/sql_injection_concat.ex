defmodule RsolvApi.Security.Patterns.Php.SqlInjectionConcat do
  @moduledoc """
...
$stmt->bind_param("s", $_POST['author']);|
  ...
  ## Examples
      ...
      iex> test_cases = RsolvApi.Security.Patterns.Php.SqlInjectionConcat.test_cases()
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Php.SqlInjectionConcat.ast_enhancement()
