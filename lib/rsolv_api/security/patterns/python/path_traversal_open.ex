defmodule RsolvApi.Security.Patterns.Python.PathTraversalOpen do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> pattern = RsolvApi.Security.Patterns.Python.PathTraversalOpen.pattern()
      iex> pattern.id
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Python.PathTraversalOpen.ast_enhancement()
