defmodule RsolvApi.Security.Patterns.Python.CommandInjectionSubprocessShell do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> pattern = RsolvApi.Security.Patterns.Python.CommandInjectionSubprocessShell.pattern()
      iex> pattern.id
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Python.CommandInjectionSubprocessShell.ast_enhancement()
