defmodule RsolvApi.Security.Patterns.Python.SqlInjectionFstring do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> pattern = RsolvApi.Security.Patterns.Python.SqlInjectionFstring.pattern()
      iex> pattern.id
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Python.SqlInjectionFstring.ast_enhancement()
