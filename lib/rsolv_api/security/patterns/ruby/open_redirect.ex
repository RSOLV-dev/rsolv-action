defmodule RsolvApi.Security.Patterns.Ruby.OpenRedirect do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> pattern = RsolvApi.Security.Patterns.Ruby.OpenRedirect.pattern()
      iex> pattern.id
      "ruby-open-redirect"
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Ruby.OpenRedirect.ast_enhancement()
