defmodule RsolvApi.Security.Patterns.Ruby.MissingAuthentication do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Ruby.MissingAuthentication.ast_enhancement()
