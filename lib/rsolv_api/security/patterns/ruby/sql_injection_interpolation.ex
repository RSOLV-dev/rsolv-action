defmodule RsolvApi.Security.Patterns.Ruby.SqlInjectionInterpolation do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> enhancement = RsolvApi.Security.Patterns.Ruby.SqlInjectionInterpolation.ast_enhancement()
