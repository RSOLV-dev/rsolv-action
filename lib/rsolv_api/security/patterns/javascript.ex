defmodule RsolvApi.Security.Patterns.Javascript do
  ...
  def command_injection_exec do
    %Pattern{
      ...
      severity: :critical,
      languages: ["javascript", "typescript"],
      regex: ~r/(?:exec|execSync)\s*\([^)]*(?:\+|\$\{)[^)]*(?:req\.|request\.|params\.|query\.|body\.|user|input|data)/i,
      default_tier: :protected,
      cwe_id: "CWE-78",
      owasp_category: "A03:2021",
  ...
  def command_injection_spawn do
    %Pattern{
      ...
      severity: :critical,
      languages: ["javascript", "typescript"],
      regex: ~r/spawn\s*\([^)]*shell\s*:\s*true[^)]*(?:req\.|request\.|params\.|query\.|body\.|user|input|data)/i,
      default_tier: :protected,
      cwe_id: "CWE-78",
      owasp_category: "A03:2021",
  ...
  def path_traversal_join do
    %Pattern{
      ...
      severity: :high,
      languages: ["javascript", "typescript"],
      regex: ~r/path\.join\s*\([^)]*(?:req\.|request\.|params\.|query\.|body\.|user|input|data)/i,
      default_tier: :protected,
      cwe_id: "CWE-22",
  ...
  def path_traversal_concat do
    %Pattern{
      ...
      severity: :high,
      languages: ["javascript", "typescript"],
      regex: ~r/(?:readFile|writeFile|unlink|mkdir|rmdir|access|stat)\s*\([^)]*["'`][^"'`]*["'`]\s*\+[^)]+(?:req\.|request\.|params\.|query\.|body\.|user|input|data)/i,
      default_tier: :protected,
      cwe_id: "CWE-22",
      owasp_category: "A01:2021",
  ...
  def hardcoded_secret_api_key do
    %Pattern{
      ...
      severity: :high,
      languages: ["javascript", "typescript"],
      regex: ~r/(?:api[_-]?key|api[_-]?secret|token)\s*[=:]\s*["'`][\w\-]{20,}["'`]/i,
      default_tier: :public,
      cwe_id: "CWE-798",
      owasp_category: "A07:2021",
  ...
  def insecure_random do
    %Pattern{
      ...
      severity: :medium,
      languages: ["javascript", "typescript"],
      regex: ~r/Math\.random\s*\(\s*\)[^;]*(?:token|key|password|secret|salt|nonce)/i,
      default_tier: :public,
      cwe_id: "CWE-330",
      owasp_category: "A02:2021",
