defmodule Rsolv.Security.Patterns.PatternBase do
  @moduledoc """
  ...
  """
  @callback pattern() :: Rsolv.Security.Pattern.t()
  ...
  defmacro __using__(_opts) do
    quote do
      @behaviour Rsolv.Security.Patterns.PatternBase
      ...
      def applies_to_file?(file_path, content_or_frameworks) do
        ...
        case pattern_meta.file_targeting do
          ...
          file_targeting ->
            ...
            apply_explicit_targeting(
              file_path,
              file_targeting,
              pattern_meta,
              content_or_frameworks
            )
        end
      end
      ...
      defp applies_to_scope?(file_path, :controllers) do
        String.contains?(file_path, "controller") or
      ...
      defp applies_to_scope?(file_path, :middleware) do
        String.contains?(file_path, "middleware") or
          String.contains?(file_path, "app/middleware/")
      end
      ...
      defp matches_embedded_languages?(content_or_frameworks, pattern_meta) do
        case content_or_frameworks do
          ...
          _ ->
            # No additional restrictions if no content provided
            true
        end
      end
      ...
      defp matches_file_extension?(file_path) do
        ...
        Enum.any?(pattern().languages, fn lang ->
          case lang do
            ...
            "php" ->
              ext in ["php", "php3", "php4", "php5", "phtml"]
      ...
      defoverridable pattern: 0,
                     vulnerability_metadata: 0,
                     ast_enhancement: 0,
                     applies_to_file?: 2
    end
  end
