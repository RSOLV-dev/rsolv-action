defmodule Rsolv.Security.Patterns.Django.MassAssignment do
  @moduledoc """
    ...
    %{
      ...
      cve_examples: [
        %{
          ...
          cvss: 9.0,
          note:
            "While a Rails vulnerability, it raised awareness of mass assignment risks across all frameworks"
        },
        %{
          id: "CVE-2022-34265",
