defmodule Rsolv.Security.Patterns.Django.MissingSecurityMiddleware do
  @moduledoc """
  ...
  def pattern do
    %Rsolv.Security.Pattern{
      ...
      recommendation:
        "Add security middleware: django.middleware.security.SecurityMiddleware, django.middleware.csrf.CsrfViewMiddleware, and django.middleware.clickjacking.XFrameOptionsMiddleware",
      test_cases: %{
        vulnerable: [
    ...
    %{
      ...
      cve_examples: [
        %{
          id: "CVE-2015-0221",
          description:
            "Django static file serving vulnerability allowing DoS through missing security headers",
          severity: "medium",
          cvss: 5.3,
        ...
        %{
          id: "CVE-2016-2512",
          description:
            "Django redirect vulnerability exploitable when security headers are missing",
          severity: "medium",
          cvss: 6.1,
        ...
        %{
          id: "CVE-2023-46695",
          description:
            "Django DoS vulnerability partially mitigated by proper middleware configuration",
          severity: "medium",
          cvss: 5.3,
