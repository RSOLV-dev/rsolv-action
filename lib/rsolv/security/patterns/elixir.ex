defmodule Rsolv.Security.Patterns.Elixir do
  ...
  alias Rsolv.Security.Patterns.Elixir.InsecureRandom
  alias Rsolv.Security.Patterns.Elixir.UnsafeAtomCreation
  alias Rsolv.Security.Patterns.Elixir.CodeInjectionEval
  alias Rsolv.Security.Patterns.Elixir.DeserializationErlang
  alias Rsolv.Security.Patterns.Elixir.PathTraversal
  alias Rsolv.Security.Patterns.Elixir.SsrfHttpoison
  alias Rsolv.Security.Patterns.Elixir.WeakCryptoMd5
  alias Rsolv.Security.Patterns.Elixir.WeakCryptoSha1
  alias Rsolv.Security.Patterns.Elixir.MissingCsrfProtection
  alias Rsolv.Security.Patterns.Elixir.DebugModeEnabled
  alias Rsolv.Security.Patterns.Elixir.UnsafeProcessSpawn
  alias Rsolv.Security.Patterns.Elixir.AtomExhaustion
  alias Rsolv.Security.Patterns.Elixir.EtsPublicTable
  alias Rsolv.Security.Patterns.Elixir.MissingAuthPipeline
  alias Rsolv.Security.Patterns.Elixir.UnsafeRedirect
  alias Rsolv.Security.Patterns.Elixir.HardcodedSecrets
  ...
  alias Rsolv.Security.Patterns.Elixir.InsufficientInputValidation
