defmodule Rsolv.Security.Patterns.Php do
  @moduledoc """
  ...
  alias Rsolv.Security.Patterns.Php.SqlInjectionInterpolation
  alias Rsolv.Security.Patterns.Php.CommandInjection
  alias Rsolv.Security.Patterns.Php.XssEcho
  alias Rsolv.Security.Patterns.Php.XssPrint
  alias Rsolv.Security.Patterns.Php.FileInclusion
  alias Rsolv.Security.Patterns.Php.FileUploadNoValidation
  alias Rsolv.Security.Patterns.Php.WeakPasswordHash
  alias Rsolv.Security.Patterns.Php.HardcodedCredentials
  alias Rsolv.Security.Patterns.Php.InsecureRandom
  alias Rsolv.Security.Patterns.Php.UnsafeDeserialization
  ...
  alias Rsolv.Security.Patterns.Php.WeakCrypto
  alias Rsolv.Security.Patterns.Php.LdapInjection
  alias Rsolv.Security.Patterns.Php.XpathInjection
  alias Rsolv.Security.Patterns.Php.EvalUsage
  alias Rsolv.Security.Patterns.Php.ExtractUsage
  alias Rsolv.Security.Patterns.Php.RegisterGlobals
  alias Rsolv.Security.Patterns.Php.OpenRedirect
  alias Rsolv.Security.Patterns.Php.MissingCsrfToken
  alias Rsolv.Security.Patterns.Php.DebugModeEnabled
  alias Rsolv.Security.Patterns.Php.ErrorDisplay
  ...
  ## Examples
      ...
      iex> patterns = Rsolv.Security.Patterns.Php.all()
      iex> length(patterns)
      25
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.sql_injection_concat()
      iex> pattern.id
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.sql_injection_interpolation()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.command_injection()
      iex> pattern.id
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.xss_echo()
      iex> pattern.id
      "php-xss-echo"
      iex> pattern.severity
      :high
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.xss_print()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.file_inclusion()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.file_upload_no_validation()
      iex> pattern.id
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.weak_password_hash()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.hardcoded_credentials()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.insecure_random()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.unsafe_deserialization()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.xxe_vulnerability()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.path_traversal()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.ssrf_vulnerability()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.session_fixation()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.weak_crypto()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.ldap_injection()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.xpath_injection()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.eval_usage()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.extract_usage()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.register_globals()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.open_redirect()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.missing_csrf_token()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.debug_mode_enabled()
  ...
  ## Examples
      ...
      iex> pattern = Rsolv.Security.Patterns.Php.error_display()
