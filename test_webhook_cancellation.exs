...
# Tests that cancellations properly downgrade to PAYG while preserving credits
...
IO.puts("All checks passed: #{all_passed and credits_preserved and not is_nil(billing_event)}")

if all_passed and credits_preserved and not is_nil(billing_event) do
