defmodule Rsolv.Repo.Migrations.AddTrialTrackingToCustomers do
  ...
  def down do
    # Drop the indexes (use drop_if_exists in case they were recreated by later migrations)
